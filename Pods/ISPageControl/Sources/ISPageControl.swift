...
open class ISPageControl: UIControl {
    ...
    @IBInspectable open var minScaleValue: CGFloat = 0.3 {
        didSet {
            setNeedsLayout()
        }
    }
    
    @IBInspectable open var middleScaleValue: CGFloat = 0.8 {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    @IBInspectable open var inactiveTransparency: CGFloat = 0 {
        didSet {
            setNeedsLayout()
        }
    }
