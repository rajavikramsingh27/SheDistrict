...
class Page_Event_VC: UIPageViewController , UIPageViewControllerDelegate, UIPageViewControllerDataSource , UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        let page_1 = storyboard.instantiateViewController(withIdentifier: "Pending_ViewController") as! Pending_ViewController
        let page_2 = storyboard.instantiateViewController(withIdentifier: "Attending_ViewController") as! Attending_ViewController
